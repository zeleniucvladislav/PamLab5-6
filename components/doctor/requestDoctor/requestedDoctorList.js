...
export default function RequestedDoctorList(props) {
  return (
      ...
      <TouchableOpacity
        ...
        onPress={() =>
          props.navigation.navigate("DoctorDetail", {
            id: props.doctor.DocId,
          })
        }
      >
        <Image
          source={{
            uri: `data:image/png;base64,${props.doctor.Photo}`,
          }}
          style={styles.image}
        />
        <View style={styles.listInfoWrapper}>
          <View style={styles.listInfo}>
            <View>
              ...
              <Text style={styles.speciality}>{props.doctor.Specs}</Text>
            </View>
            <View style={styles.ratingWrapper}>
              <AntDesign
                ...
                color="#FED500"
              />
              <Text style={styles.rating}>{props.doctor.Stars}</Text>
            </View>
          </View>
          <View style={styles.location}>
            <SimpleLineIcons name="location-pin" size={22} color="#92A6B0" />
            <Text style={styles.address}>{props.doctor.Address}</Text>
          </View>
        </View>
      </TouchableOpacity>
    </View>
